...
Para graficar empleamos el comando `plot()` pero este te grafica un mapa por cada columna que tenga el shape. Entonces para eso especificamos la columna que queremos
...
1.  para el grafico con sf tienes que especificar el numero de columna mientras que con terra si puedes añadir el nombre de la columna
...
```{r}
crs(shp2)
shp2 # Tambien la coordenada se puede consultar con esta funcion 
```
